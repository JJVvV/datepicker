...
(function(root, factory) {
    return root._mu.Playlist = factory(root._mu.utils,root._mu.Events);
})(window, function(utils, Events) {
  var Playlist;
  Playlist = (function() {
...
(function(root, factory) {
    return root._mu.EngineCore = factory(root._mu.cfg, root._mu.utils, root._mu.Events);
})(window, function(cfg, utils, Events) {
...
(function(root, factory) {
    return root._mu.AudioCore = factory(root._mu.cfg, root._mu.utils, root._mu.EngineCore,root. _mu.Modernizr);
})(window, function(cfg, utils, EngineCore, Modernizr) {
...
(function(root, factory) {
    return root._mu.FlashCore = factory(root._mu.cfg,root._mu.utils, root._mu.Timer,root._mu.EngineCore);
})(window, function(cfg, utils, Timer, EngineCore) {
...
(function(root, factory) {
    return root._mu.FlashMP3Core = factory(root._mu.cfg, root._mu.FlashCore);
})(window, function(cfg, FlashCore) {
...
(function(root, factory) {
    return root._mu.FlashMP4Core = factory(root._mu.cfg,root._mu.FlashCore);
})(window, function(cfg, FlashCore) {
...
(function(root, factory) {
    return root._mu.Engine = factory(
        root._mu.cfg
            ...
            , root._mu.EngineCore
            , root._mu.AudioCore
                        , root._mu.FlashMP3Core
            , root._mu.FlashMP4Core
                    );

})(window, function(cfg, utils, Events, EngineCore, AudioCore, FlashMP3Core, FlashMP4Core) {
...
(function(root, factory) {
    return root._mu.Player = factory(root._mu.cfg, root._mu.utils, root._mu.Timer,root. _mu.Events,root. _mu.Playlist, root._mu.Engine);
})(window, function(cfg, utils, Timer, Events, Playlist, Engine) {
...
window.player = new _mu.Player({
    ...
    baseDir: '/redux-launchr/public/flash',
    mode: 'single',
    engines: [{constructor: 'FlashMP3Core',type:_mu.FlashMP3Core}]
});