...
DateRangePicker.prototype = {
    ...
    renderCalendar: function(side) {
        ...
        if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
            html += '<th class="prev available"><i class="fa fa-chevron-left demo-icon icon-glyph-135"></i></th>';
        } else {
            html += '<th><i class="fa fa-chevron-left demo-icon icon-glyph-135"></i></th>';
        }
        ...
        if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
            html += '<th class="next available"><i class="fa fa-chevron-right demo-icon icon-glyph-136"></i></th>';
        } else {
            html += '<th><i class="fa fa-chevron-right demo-icon icon-glyph-136"></i></th>';
        }
